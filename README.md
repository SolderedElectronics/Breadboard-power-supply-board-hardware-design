...
| ![Breadboard power supply board](https://github.com/SolderedElectronics/Breadboard-power-supply-board-hardware-design/blob/main/OUTPUTS/V1.1.1/333084.jpg?raw=true) |
| :----------------------------------------------------------: |
|      [Buy Breadboard power supply board](https://www.solde.red/333084)      |

If you need simple and stable power source for your breadboard projects, this board is here to help. Supply it with DC jack DC power or using UCB-C cable, and the board provides 3V3, 5V or 12V directly to the power supply lines on the breadboard. Output voltages are adjustable seperately using the onboard switched. There's power LED, power switch and automatic voltage selection circuit, in case both power inputs are there.
